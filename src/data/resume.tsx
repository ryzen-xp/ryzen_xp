...
export const DATA = {
  ...
  skills: [
    ...
    { name: "Solidity", logoUrl: "/skills/solidity.png", invertInDark: true },
    { name: "Cairo", logoUrl: "/skills/cairo.png" },
    { name: "C++", icon: Icons.terminal },
    { name: "Node.js", icon: Nodejs },
    { name: "Axum", logoUrl: "/skills/axum.png", invertInDark: true },
    { name: "PostgreSQL", icon: Postgresql },
    { name: "React", icon: ReactLight },
    { name: "Next.js", icon: NextjsIconDark },
    { name: "Docker", icon: Docker },
    { name: "Foundry", logoUrl: "/skills/foundry.png" },
    { name: "Web3.js", logoUrl: "/skills/web3js.png" },
    { name: "Starknet.js", logoUrl: "/skills/starknetjs.png" },
    { name: "stellar-sdk", logoUrl: "/skills/stellar-sdk.png", invertInDark: true },
  ],
  blockchains: [
    {
      name: "Stellar",
